...
@Component({
  selector: 'app-dashboardpie',
  templateUrl: './dashboardpie.component.html',
  styleUrls: ['./dashboardpie.component.css']
})
export class DashboardpieComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let myChart = new Chart(this.MyChart.nativeElement, {
      type: 'pie',
      data: {
        labels: ["Tapperwala","10 No. market", "DB city mall", "GTB complex", "Manohar Diary"],
        datasets: [{
