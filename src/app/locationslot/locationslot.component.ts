...
@Component({
  selector: 'app-locationslot',
  templateUrl: './locationslot.component.html',
  styleUrls: ['./locationslot.component.css']
})
export class LocationslotComponent implements OnInit {
